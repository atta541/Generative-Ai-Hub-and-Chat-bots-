...
// import SubscriptionAlert from './SubscriptionAlert';  // Import the SubscriptionAlert component
...
//         try {
//             const res = await axios.post('http://127.0.0.1:8000/api/gpt3.5/', { message }, {
//                 headers: {
...
//             const errorMessage = { type: 'bot', text: 'Please subscribe the subscription to use.' };
//             setChatHistory(prev => [...prev, errorMessage]);
//         } finally {
