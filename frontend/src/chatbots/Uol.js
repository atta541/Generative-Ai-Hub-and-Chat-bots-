        ...
        <div className={`flex flex-col h-full font-sans ${darkMode ? 'bg-gray-900' : ''}`} style={{ width: '100%' }}>
            <div className={`flex justify-between items-center -mt-4 border-gray-300 ${darkMode ? '' : ''}`}>
                <div className="flex items-center">
                    <h2 className={`text-2xl ${darkMode ? 'text-white' : 'text-black'}`}>Chat with UOL</h2>
                </div>
                <button
            ...
            {/* Added text about the chatbot */}
            <div className={`text-center p-2 ${darkMode ? 'text-white' : 'text-black'}`}>
                This chatbot is fine-tuned on the University of Lahore dataset, Lahore campus.
            </div>
