...
//                     <h2 className={`text-2xl ${darkMode ? 'text-white' : 'text-black'}`}>LlaMa 3.2-11b vision model</h2>
//                 </div>
...
//                                 style={{ maxWidth: '70%' }}
//                             >
//                                 {/* Check if msg.text is an object */}
...
const Llama32 = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const botMessage = { type: 'bot', text: botResponse.response || '' };

            // If there's an image response
            if (botResponse.image) {
                botMessage.image = botResponse.image;  // Store image for rendering
            }
                ...
                <div className="flex flex-col">
                    {chatHistory.map((msg, index) => (
                        ...
                        >
                            ...
                            >
                                {msg.image ? (
                                    <img src={msg.image} alt="Bot Response" style={{ width: '100%', height: 'auto' }} />
                                ) : (
                                    msg.text
                                )}
